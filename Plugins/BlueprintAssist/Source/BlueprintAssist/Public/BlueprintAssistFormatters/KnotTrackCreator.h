...
private:
	...
	UEdGraphPin* DoesNeedExecTrack(UEdGraphPin* ParentPin, TArray<UEdGraphPin*> LinkedPins);

	TSharedPtr<FKnotNodeTrack> MakeKnotTracksForLinkedExecPins(UEdGraphPin* ParentPin, TArray<UEdGraphPin*> LinkedPins, TSet<UEdGraphPin*>& PinsRequiringTracks);
